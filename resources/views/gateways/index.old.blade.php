    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row" id="main-headers">
                <div class="col-sm-2">پرونده</div>
                <div class="col-sm-1">شهر</div>
                <div class="col-sm-2">سریال کنتور</div>
                <div class="col-sm-1">ارتباط</div>
                <div class="col-sm-1">آخرین حضور</div>
                <div class="col-sm-3">
                    <div class="col-sm-6">رله 1</div>
                    <div class="col-sm-6">رله 2</div>
                </div>
...
<th>وضعیت رله 2</th><th>عملیات</th></tr></thead><tbody>`;
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                var relay1 = `<span style='font-size:12px;'> وصل </span>
<label class="switch">
...
<span style="font-size:12px;"> قطع </span>`;
                                ...
                                var relay2 = `<span style='font-size:12px;'> وصل </span>
<label class="switch">
